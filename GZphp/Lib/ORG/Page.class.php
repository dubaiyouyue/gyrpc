...
class Page extends Think {
	...
	public function  show($nxxxlllpage){
		...
		$output .= '<a class="newdiyiyexiaoli" href="'.$this->pageurl($urlrule, 1,$this->parameter).'">'.L('first_page').'</a>';
		...
		$output .='<a class="newzuihouyiyexiaoli" href="'.$this->pageurl($urlrule,$this->totalPages,$this->parameter).'">'.L('Last_page')."</a>";
		return $output;
	}
