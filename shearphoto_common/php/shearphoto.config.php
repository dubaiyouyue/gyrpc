...
), "water"=>false,//"water" => "../images/waterimg2.png", //只接受PNG水印，当然你对PHP熟练，你可以对主程序进行修改支持其他类型水印,不设就"water"=>false
...
"filename" => time().rand(1000,9999) . "_"//截好后的图片的文件名字定义！要生成多个文件时 系统会自动在后面补上  "width"=>array()参数定义的名称,请查看上面的"width"=>array()
);
