    ...
    public function _catpos($attr) {
        ...
        if (is_numeric($tag['catid'])) {
            ...
            foreach ($arrparentid as $cid) {
                $parsestr[] = '<a class="xlnewacolor'.$cid.'" href="' . $category_arr[$cid]['url'] . '">' . $category_arr[$cid]['catname'] . '</a>';
            }unset($category_arr);
            ...
            $parsestr .= '$parsestr[] = \'<a class="xlnewacolor\'.$Categorys[$cid][\'id\'].\'" href="\'.$Categorys[$cid][\'url\'].\'">\'.$Categorys[$cid][\'catname\'].\'</a>\';?>';
